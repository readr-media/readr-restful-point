...
func (r *pointsHandler) bindPointsQuery(c *gin.Context, args *PointsArgs) (err error) {
...
func (r *pointsHandler) Post(c *gin.Context) {
	...
	points, id, err := PointsAPI.Insert(pts)
	if err != nil {
		switch err.Error() {
